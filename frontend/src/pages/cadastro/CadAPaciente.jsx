...
import { CadastroCard, Form, Actions } from "../../styles/Cadastro"
...
export const CadastroPaciente = () => {
  ...
  async function handleSubmit(e) {
    ...
    try {
      setLoading(true)
      // envia booleans de perfis como false para paciente
    ...
    <PageContainer>
      <CadastroCard>
        <div style={{ position: 'relative', width: '100%', marginBottom: 12 }}>
          <Titulo style={{ margin: 0, textAlign: 'center' }}>Cadastro - Paciente</Titulo>
        </div>
